    ...
    class LR_Social_Login_Admin_Settings {
            ...
            <div class="lr-sidebar">
                <div class="lr-frame">
                    ...
                    <div>
                        ...
                        <a target="_blank" href="http://ish.re/NQV2"><?php _e('Social SDKs', 'LoginRadius') ?></a>
                    </div>
                </div>
            </div>
            <?php
                ...
                <div class="lr_options_container">
                    <div class="lr-row">
                        ...
                        <div>
                            ...
                            <label class="lr-show-toggle" for="lr-clicker-login-form"><?php _e('Login page of your WordPress site', 'LoginRadius'); ?>
                        ...
                        <div>
                            ...
                            <label class="lr-show-toggle" for="lr-clicker-reg-form"><?php _e('Registration page of your WordPress site', 'LoginRadius'); ?>
                    ...
                    <div class="lr-row">
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('Page the user is redirected to after login', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                            ...
                            <label>
                                ...
                                <span><?php _e('Redirect to the user\'s account dashboard', 'LoginRadius'); ?></span>
                            </label>
                            <?php
                            if (isset($loginRadiusLoginIsBpActive) && $loginRadiusLoginIsBpActive) {
                                ?>
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('Page the user is redirected to after registration', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('Page the user is redirected to after logout [Note: The logout function only works when clicking \'Logout\' in the social login widget area. In all other cases, WordPress\' default logout function will be applied.]', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                        ...
                        <div>
                            ...
                            <label>
                                <span class="lr_property_title">
                                    ...
                                    <span class="lr-tooltip" data-title="<?php _e('Enter the title of the Social Login interface', 'LoginRadius'); ?>">
                                        <span class="dashicons dashicons-editor-help"></span>
                                    </span>
                                </span>
                        ...
                        <div>
                            <label style="line-height:41px;">
                                <span class="lr_property_title" style="margin-top:0px;">
                                    ...
                                    <span class="lr-tooltip" data-title="<?php _e('Select the size of the icons in your Social Login interface. This option does not apply to all Social Login themes.', 'LoginRadius'); ?>">
                                        <span class="dashicons dashicons-editor-help"></span>
                                    </span>
                                </span>
                        ...
                        <div>
                            <label>
                                <span class="lr_property_title">
                                    ...
                                    <span class="lr-tooltip" data-title="<?php _e('Enter the number of social icons to display in each row', 'LoginRadius'); ?>">
                                        <span class="dashicons dashicons-editor-help"></span>
                                    </span>
                                </span>
                        ...
                        <div>
                            <label>
                                <span class="lr_property_title">
                                    ...
                                    <span class="lr-tooltip" data-title="<?php _e('Select the background color of the Social Login interface', 'LoginRadius'); ?>">
                                        <span class="dashicons dashicons-editor-help"></span>
                                    </span>
                                </span>
                                <?php
                ...
                <div class="lr_options_container">
                    <div class="lr-row">
                        <h3>
                            ...
                            <span class="lr-tooltip tip-bottom" data-title="<?php _e('Turn on, if you want to enable Social Commenting', 'LoginRadius'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                        </h3>
                        <div>
                            ...
                            <div class="lr-commenting-options">
                                <h4>
                                    ...
                                    <span class="lr-tooltip" data-title="<?php _e('Select the position of the Social Login interface on WordPress commenting form', 'LoginRadius'); ?>">
                                        <span class="dashicons dashicons-editor-help"></span>
                                    </span>
                                </h4>
                                <label>
        ...
        private static function advanced_options($loginRadiusSettings) {
            ...
            <div id="lr_options_tab-4" class="lr-tab-frame">
                <div class="lr_options_container">
                    <div class="lr-row">
                        <h3><?php _e('Short Code for Social Login', 'LoginRadius'); ?>
                            <span class="lr-tooltip tip-bottom" data-title="<?php _e('Copy and paste the following shortcode into a page or post to display a social login interface', 'LoginRadius'); ?>">
                                <span class="dashicons dashicons-editor-help"></span>
                            </span>
                        </h3>
                        <div>
                        ...
                        <span><?php _e("Additional shortcode examples can be found <a target='_blank' href='http://ish.re/BENH/#shortcode' >Here</a>", 'LoginRadius'); ?></span>
                    </div><!-- lr-row -->
                </div>
                    ...
                    <div class="lr-row">
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('Turn on, if you would like to prompt users for their email address in a separate pop-up', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <div>
                        ...
                        <div class="lr-row lr-get-email-messages">
                            <h4>
                                <?php _e('Enter the pop-up message asking users to enter their email address', 'LoginRadius'); ?>
                                <span class="lr-tooltip" data-title="<?php _e('The name of the social provider will be automatically filled in if you use @provider', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                            ...
                            <h4>
                                <?php _e('Enter the message the user receives when their email address is already registered', 'LoginRadius'); ?>
                                <span class="lr-tooltip" data-title="<?php _e('This is the message that will be displayed to the user if the email address they are registering with is already taken', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                    ...
                    <div class="lr-row">
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('During account creation, a separator is automatically added between the user\'s first name and last name', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('You can enable/disable the user from the Status column on the Users page in WordPress admin screens', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                            ...
                            <div id="loginRadiusDefaultStatus" class="lr-row">
                                <h5>
                                    ...
                                    <span class="lr-tooltip" data-title="<?php _e('Select whether you would like the user to be set as an active or inactive user after the initial registration process', 'LoginRadius'); ?>">
                                        <span class="dashicons dashicons-editor-help"></span>
                                    </span>
                                </h5>
                                <label>
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('Select Yes, if you want to see the list of social providers the user account is linked with in the user list', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                                ...
                                <span><?php _e('Yes, display the social network(s) that the user is connected with in the user list', 'LoginRadius'); ?></span>
                            </label>
                            <label>
                                ...
                                <span><?php _e('No, do not display the social network(s) that the user is connected with in the user list', 'LoginRadius'); ?></span>
                            </label>
                        </div>
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('If you disable this option, the user profile data will be saved only once when the user logs in for the first time on your website, and this data will not be updated again in your WordPress database, even if the user updates their social account.', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('Select Yes, if you want to let users use their profile picture from their linked social account as an avatar on your website', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                                ...
                                <span><?php _e('Yes, use the small avatars', 'LoginRadius'); ?></span>
                            </label>
                            <label>
                                ...
                                <span><?php _e('Yes, use the large avatars', 'LoginRadius'); ?></span>
                            </label>
                            <label>
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('Select Yes, If you want to enable social account linking. This option will also shows users the linking interface on the wordpress dashboard that allows users to link their other social providers', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('Choose Yes, if you want the user to receive an email notification about their WordPress username and password after registration', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                    ...
                    <div class="lr-row">
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('Select Yes, if you want to Social Login errors reported', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                        ...
                        <form action="options.php" method="post">
                            ...
                            <p class="submit">
                                <a href="<?php echo htmlspecialchars(add_query_arg(array('preview' => 1, 'template' => get_option('template'), 'stylesheet' => get_option('stylesheet'), 'preview_iframe' => true, 'TB_iframe' => 'true'), get_option('home') . '/')); ?>" class="thickbox thickbox-preview" id="preview" >
                                    <?php _e('Preview', 'LoginRadius'); ?>
                                </a>
                                <input style="margin-left:10px" type="submit" name="save" class="button button-primary" value="<?php _e('Save Changes', 'LoginRadius'); ?>" />
                            </p>
                        </form>
