...
add_action( 'wp_enqueue_scripts', 'etheme_add_google_fonts', 5);

function etheme_add_google_fonts() {
		echo '<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Open+Sans" media="screen">';
		echo '<link href="http://fonts.googleapis.com/css?family=Lato:100,400" rel="stylesheet" type="text/css">';
}
