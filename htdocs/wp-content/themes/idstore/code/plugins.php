...
function etheme_register_required_plugins() {
	$plugins = array(
		...
		array(
			'name'     				=> 'Paypal Advanced Payment Gateway for WooCommerce', // The plugin name
			'slug'     				=> 'wc-gateway-paypal-advanced', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory_uri() . '/code/plugins/wc-gateway-paypal-advanced.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> true, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
