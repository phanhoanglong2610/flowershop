...
if ( $count > 0 ) {
    ...
    echo '<span class="star-rating" title="'.sprintf(__('Rated %s out of 5', ETHEME_DOMAIN), $average).'"><span style="width:'.($average*10).'px"><span class="rating">'.$average.'</span> </span></span>';
