...
<form id="order_review" method="post">
	...
	<table class="table">
		<thead>
			<tr>
				...
				<th><?php _e('Qty', ETHEME_DOMAIN); ?></th>
				<th><?php _e('Totals', ETHEME_DOMAIN); ?></th>
			</tr>
		</thead>
		<tfoot>
		<?php
	...
	<div id="payment">
		...
		<div class="form-row">
			...
			<input type="submit" class="button alt" id="place_order" value="<?php _e('Pay for order', ETHEME_DOMAIN); ?>" />
