...
<?php endif; ?>
			...
			<header class="title">				
				...
				<a href="<?php echo esc_url( add_query_arg('address', 'billing', get_permalink(woocommerce_get_page_id('edit_address'))) ); ?>" class="edit"><?php _e('Edit', ETHEME_DOMAIN); ?></a>	
			</header>
			<address>
				<?php
					$address = array(
					...
					if (!$formatted_address) _e('You have not set up a billing address yet.', ETHEME_DOMAIN); else echo $formatted_address;
				?>
			</address>
...
<?php if (get_option('woocommerce_ship_to_billing_address_only')=='no') : ?>
		...
		<div class="col-2">
			...
			<header class="title">
				...
				<a href="<?php echo esc_url( add_query_arg('address', 'shipping', get_permalink(woocommerce_get_page_id('edit_address'))) ); ?>" class="edit"><?php _e('Edit', ETHEME_DOMAIN); ?></a>
			</header>
			<address>
				<?php
					$address = array(
					...
					if (!$formatted_address) _e('You have not set up a shipping address yet.', ETHEME_DOMAIN); else echo $formatted_address;
				?>
			</address>
