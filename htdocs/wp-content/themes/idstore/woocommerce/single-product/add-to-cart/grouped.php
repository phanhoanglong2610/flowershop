...
<form action="<?php echo esc_url( $product->add_to_cart_url() ); ?>" class="cart" method="post" enctype='multipart/form-data'>
				...
				<tr>
					<td style="width: 140px;">
						...
						<?php elseif ( ! $quantites_required ) : ?>
							...
							<button type="submit" name="quantity[<?php echo $child_product['product']->id; ?>]" value="1" class="button alt"><?php _e('Add to cart', ETHEME_DOMAIN); ?></button>
	...
	<?php if ( $quantites_required ) : ?>
		...
		<button type="submit" class="button big active"><span><?php echo apply_filters('single_add_to_cart_text', __('Add to cart', ETHEME_DOMAIN), $product->product_type); ?></span></button>
