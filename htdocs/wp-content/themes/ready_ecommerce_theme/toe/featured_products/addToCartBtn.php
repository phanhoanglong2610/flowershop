<?php echo html::formStart('featuredProdWidg'. $this->post->ID, array('attrs' => 'onsubmit="toeAddToCart(this, \'\', true); return false;"', 'method' => 'POST')) ?>
	...
	<?php echo html::submit('add', array('value' => lang::_('Add')))?>
