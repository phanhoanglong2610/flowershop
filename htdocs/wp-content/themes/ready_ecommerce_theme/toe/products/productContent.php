...
jQuery(document).ready(function(){
	...
	var gallery_position = "<?php echo $this->viewOptions['gallery_position'];?>";
	if(gallery_position == "right")
		jQuery(".product_main").css("float","right");
	else
		jQuery(".product_main").css("float","left");
	
	/* Add to cart button text color */
	var color = "<?php echo $this->viewOptions['add_to_cart_text'];?>";
	jQuery(".addtocartbtn input[type=submit]").css("color",color);
});
</script>
				...
				<div class="product_main">
					<?php if ($this->viewOptions['full_image']) :?>
						...
						<div class="product_full_image">
							<a href="<?php echo $this->image['big'][0]?>" title="<?php lang::_e('Click to enlarge');?>" rel="">
					...
					<?php if ($this->viewOptions['preview_images']) :?>
						...
						<div class="product_slider">
							...
							<?php foreach($this->images as $image) :?>
								<li>
									<a href="<?php echo $image['big'][0]?>" title="<?php lang::_e('Click to enlarge');?>" rel="">
					...
					<div id="product_tabs">
						<ul>
							...
							<?php if ($this->viewOptions['full_descr']) :?>
								<li><a href="#product_description">
									<?php lang::_e('Thông tin sản phẩm')?>
								</a></li>
							<?php endif;?>
							<!--/toefull_description-->
							<!--toeproperties-->
