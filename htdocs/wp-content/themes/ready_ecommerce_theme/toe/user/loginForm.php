...
<?php if(!$this->fieldsOnly) {
    ...
    <table id="toeLoginFormFields">
        <tr>
            <td>
                <div class="forminput">
                    <?php echo html::text('user_login', array('attrs' => 'placeholder="'.__('Username').'"'))?>
        ...
        <tr>
            <td>
                <div class="forminput">
                    <?php echo html::password('user_password', array('attrs' => 'placeholder="'.__('Password').'"'))?>
		...
		<tr>
			<td>
				<?php echo html::checkbox('remember', array('value' => 1, 'attrs' => 'id="remember"'))?>
				<label for="remember"><?php lang::_e('Remember Me')?></label>				
        ...
        <tr>
            <td>
                ...
                <?php echo html::submit('login', array('value' => lang::_('Sign In'), 'attrs' => 'class="tcf_submit" id="toeLoginFormSubmit"'))?>
