...
<div class="sp_todo">
		...
		<div class="fright">    
				...
				<a class="tcf_submit" href="<?php echo frame::_()->getModule('pages')->getLink(array('mod' => 'checkout', 'action' => 'getAllHtml'))?>"><?php lang::_e('Proceed to Checkout')?></a>
				<div class="clear"></div>
		</div>
		<div class="clr"></div>
</div>
...
<table class="shopping_cart">
	...
	<tr>
        <?php foreach($this->columns as $cKey => $cInfo) { ?>
            ...
            <th class="shopping_cart_<?php echo $cKey?>"><?php lang::_e($cInfo['title'])?></th>
            <?php endif; ?>
        <?php }?>
    </tr>
    </thead>
            ...
            switch($cKey) {
                ...
                case 'action': ?>
                    ...
                    <td class="sc_action">
						...
						<?php }?>
						<?php echo html::hidden('inCartId', array('value' => $inCartId)); ?>
						<a href="#" class="remove_from_cart">Remove</a>
					</td>
                    <?php }?>
                <?php break;
            }
