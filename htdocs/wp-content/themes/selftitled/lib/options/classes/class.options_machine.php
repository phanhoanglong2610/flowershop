		...
		foreach ($options as $value) {
			...
			switch ( $value['type'] ) {
				...
				case 'backup':
					...
					$output .= '<p><strong>'. __('Last Backup : ', "selftitled").'<span class="backup-log">'.$log.'</span></strong></p></div>'."\n";
					$output .= '<a href="#" id="of_backup_button" class="button" title="Backup Options">' . __('Backup Options', "selftitled") . '</a>';
					$output .= '<a href="#" id="of_restore_button" class="button" title="Restore Options">' . __('Restore Options', "selftitled") . '</a>';
					$output .= '</div>';
				...
				case 'transfer':
					...
					$output .= '<a href="#" id="of_import_button" class="button" title="Restore Options">' . __('Import Options', "selftitled") . '</a>';
