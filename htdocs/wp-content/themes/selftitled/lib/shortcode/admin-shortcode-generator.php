...
-----------------------------------------------------------------------------------*/
	...
	function Ar_Shortcode_Generator () {
...
function framework_url() {
	return esc_url( trailingslashit( get_template_directory_uri() . '/lib/shortcode/'));
} // End framework_url()
...
$ar_shortcode_generator = new Ar_Shortcode_Generator();
?>