(
	...
	function(){
		...
		var icon_url = framework_url[0] + '/images/shortcode.png';
				...
				init: function(d,e) {
						...
						d.addCommand( "wooOpenDialog",function(a,c){
							...
							jQuery.get(e+"/dialog.php?woo-shortcodes-nonce=" + nonce,function(b){
								...
								tb_show( "Insert New "+ wooSelectedShortcodeTitle +" Shortcode", "#TB_inline?width="+f+"&height="+b+"&inlineId=woo-dialog" );jQuery( "#woo-options h3:first").text( "Customize the "+c.title+" Shortcode" );
