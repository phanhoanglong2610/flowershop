...
$info_message = apply_filters('woocommerce_checkout_login_message', __('<strong>Already registered?</strong>', 'woocommerce'));
?>

<p class="woocommerce_info well"><?php echo $info_message; ?> <a href="#" class="showlogin"><?php _e('Click here to login', 'woocommerce'); ?></a></p>
