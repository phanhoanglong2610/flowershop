...
<form id="order_review" method="post">
	...
	<div id="payment">
		...
		<ul class="payment_methods methods well">
			<?php
				...
				if ($available_gateways) :
					...
					foreach ($available_gateways as $gateway ) :
						?>
						<li>
							<label class="radio" for="payment_method_<?php echo $gateway->id; ?>">
		...
		<div class="form-row">
			...
			<input type="submit" class="button btn alt" id="place_order" value="<?php _e('Pay for order', 'woocommerce'); ?>" />
