...
<div id="order_review">
	...
	<div id="payment" class="well">
						...
						<li>
							...
							<?php
								if ( $gateway->has_fields() || $gateway->get_description() ) :
									...
									<blockquote><?php $gateway->payment_fields(); ?></blockquote>
									<?php echo '</div>';
								endif;
							?>
						</li>
		...
		<div class="form-row place-order">
			...
			<input type="submit" class="button alt btn theme" name="woocommerce_checkout_place_order" id="place_order" value="<?php echo apply_filters('woocommerce_order_button_text', __( 'Place order', 'woocommerce' )); ?>" />
