...
<?php endif; ?>
			...
			<header class="title clearfix">
				<div class="pull-left"><h5><?php _e('Billing Address', 'woocommerce'); ?></h5></div>
				<div class="pull-right"><i class="icon-pencil"></i> <a href="<?php echo esc_url( add_query_arg('address', 'billing', get_permalink(woocommerce_get_page_id('edit_address'))) ); ?>" class="edit"><?php _e('Edit', 'woocommerce'); ?></a></div>
			</header>
			<address>
				<?php
					$address = array(
...
<?php if (get_option('woocommerce_ship_to_billing_address_only')=='no') : ?>
		...
		<div class="col-2 span6 well">
			...
			<header class="title clearfix">
				...
				<div class="pull-left"><h5><?php _e('Shipping Address', 'woocommerce'); ?></h5> </div>
				<div class="pull-right"><i class="icon-pencil"></i> <a href="<?php echo esc_url( add_query_arg('address', 'shipping', get_permalink(woocommerce_get_page_id('edit_address'))) ); ?>" class="edit"><?php _e('Edit', 'woocommerce'); ?></a></div>
